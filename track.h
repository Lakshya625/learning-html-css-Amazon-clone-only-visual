...
defined, undefined, or ot accessible at all:

  #define mi_track_mem_defined(p,size)
  #define mi_track_mem_undefined(p,size)
  #define mi_track_mem_oaccess(p,size)
...
#define mi_track_mem_oaccess(p,size)             VALGRIND_MAKE_MEM_oACCESS(p,size)
...
#define mi_track_mem_oaccess(p,size)             ASAN_POISON_MEMORY_REGION(p,size)
...
#define mi_track_align(p,alignedp,offset,size)  mi_track_mem_oaccess(p,offset)
#endif
